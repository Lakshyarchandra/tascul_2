  ...
  return (
    ...
    >
      ...
      <header className="w-full flex items-center justify-start">
        <div className="header-content text-left mr-64">
          <h1 className="text-5xl font-bold text-[#7d624a] mb-4 ml-4 drop-shadow-lg">Welcome to TasCul</h1>
          <p className="text-lg text-[#e0e4f1] max-w-xl mb-8 ml-4 leading-7">
          ...
          <Link 
            to="/signin"  // Set the destination for the link to Sign-In page
        ...
        <img src={headerImage} alt="Description" className="header-image ml-8 w-96" />
      </header>

      {/* Video Section */}
      <section className="video-section my-8 w-4/5">
        <h2 className="text-3xl font-semibold text-center text-[#7d624a]">Know About Us</h2>
        <div className="video-card flex items-center justify-center bg-[#1f263d] rounded-lg p-4 shadow-lg mt-4 max-w-3xl mx-auto">
          ...
          <div className="video-description text-left ml-4 max-w-xs">
      ...
      <section className="features mt-8">
        ...
        <div className="feature-cards flex flex-wrap gap-6 justify-center mt-6 px-4">
